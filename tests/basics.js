...
module.exports = testCase({
  'TC 1: stability tests': testCase({
    'loading prettySeconds function (require)': function (t) {
      prettySeconds = require('../index.js')
  ...
  'TC 2: real tests': testCase({
    ...
    'test with seconds as floats': function (t) {
      ...
      result = prettySeconds(92.00000000000000000000000001)
